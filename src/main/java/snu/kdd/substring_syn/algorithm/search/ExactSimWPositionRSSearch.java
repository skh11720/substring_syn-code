...
public class ExactSimWPositionRSSearch extends PositionRSSearch {

	protected final NaiveWindowBasedValidator validator;

	
	public ExactSimWPositionRSSearch( double theta, boolean bLF, boolean bPF, IndexChoice indexChoice ) {
	...
	public String getName() {
		return "ExactSimWPositionRSSearch";
	}
}
