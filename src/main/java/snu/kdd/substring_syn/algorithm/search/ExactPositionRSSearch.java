...
public class ExactPositionRSSearch extends PositionRSSearch {

	protected final NaiveValidator validator;

	
	public ExactPositionRSSearch( double theta, boolean bLF, boolean bPF, IndexChoice indexChoice ) {
